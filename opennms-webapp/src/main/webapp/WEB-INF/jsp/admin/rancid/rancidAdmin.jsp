 ...
 *
 * Copyright (C) 2009-2014 The STL-NMS Group, Inc.
  ...
  <div class="col-md-6">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p>Detailed Documentation on all options can be found on <a title="The STL-NMS Project wiki" href="http://www.opennms.org" target="new">the STL-NMS wiki</a>.
        </p>
