 ...
 *
 * Copyright (C) 2010-2018 The STL-NMS Group, Inc.
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            ...
                            <a href="<c:out value="${results.RTUrl}" />">STL-NMS support portal</a>.
                        </p>
            ...
            <c:otherwise>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            Enter your STL-NMS Group commercial support login to open a support ticket or view your open
                            issues.
                        </p>
                        <p>
