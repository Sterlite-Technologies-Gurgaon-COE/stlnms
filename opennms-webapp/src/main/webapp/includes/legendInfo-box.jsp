...
<p>
An Application is defined by a subset of the set of IP based services created in STL-NMS
</p>
<p>
A Location is an arbitrary entity defined through configuration by the STL-NMS user
</p>
<p>
