...
<div class="row">
  ...
  <p>
    ...
    small tweaks to what STL-NMS monitors.
    When STL-NMS was first started, the nodes, interfaces, and services
  ...
  <p>
    ...
    contact your STL-NMS administrator for assistance.
  </p>
  <% } %>
