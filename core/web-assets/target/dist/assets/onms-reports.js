...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/apps/onms-classifications/views/modals/popover.html';
...
var escapeSearchValue = function escapeSearchValue(value) {
  if (typeof value === 'string') {
    return value.replace('!', '%21').replace('$', '%24').replace('\'', '%27').replace('(', '%28').replace(')', '%29') // People are going to type this in as a wildcard, so I
...
var normalizeOffset = function normalizeOffset(offset, maxOffset, limit) {
  var newOffset = offset; // Offset of the last page
  ...
  newOffset = newOffset > lastPageOffset ? lastPageOffset : newOffset; // Make sure that offset is a multiple of limit
...
}]).directive('onmsListEditInPlace',
/* @ngInject */
function () {
  return {
    controller: ["$scope", function controller($scope) {
      $scope.editing = false;
      $scope.originalValue = angular.copy($scope.value); // Start editing the value
      ...
      $scope.submit = function () {
        $scope.onSubmit(); // TODO: Handle update failures
        // Now that we've save a new value, use it as the original value

        $scope.originalValue = $scope.value; // Switch out of edit mode
      ...
      $scope.cancel = function () {
        ...
        $scope.value = $scope.originalValue; // Switch out of edit mode
...
}).directive('onmsListEditListInPlace',
/* @ngInject */
["$window", function ($window) {
  return {
    controller: ["$scope", function controller($scope) {
      $scope.editing = false; // Start editing the value
      ...
      $scope.add = function (items, item) {
        items.push(item);
        (0, _sort.default)(items).call(items); // TODO: Handle update failures

        $scope.onEdit(); // Switch out of edit mode
...
}]).directive('onmsListEditMapInPlace',
/* @ngInject */
["$window", function ($window) {
  return {
    controller: ["$scope", function controller($scope) {
      ...
      $scope.add = function (items, key, value) {
        items[key] = value; // TODO: Handle update failures
...
.controller('ListCtrl', ['$scope', '$location', '$window', '$log', '$filter', function ($scope, $location, $window, $log, $filter) {
  ...
  var initialLimit = typeof $location.search().limit === 'undefined' ? $scope.defaults.limit : Number($location.search().limit) > 0 ? Number($location.search().limit) : $scope.defaults.limit; // Restore any query parameters that you can from the 
  ...
  $scope.$watch('query', function () {
    var queryParams = angular.copy($scope.query); // Delete derived values that we don't need in the query string

    delete queryParams.searchClauses;
    delete queryParams.newLimit;
    delete queryParams.lastOffset;
    delete queryParams.maxOffset; // Rename searchParam to _s

    queryParams._s = queryParams.searchParam === '' ? null : queryParams.searchParam;
    delete queryParams.searchParam; // Delete any parameters that have default or blank values
  ...
  $scope.replaceSearchClause = function (oldClause, newClause) {
    ...
    if (!scopeOldClause) {
      ...
      } else {// If the old clause is not present and the new clause is already
  ...
  $scope.setLimit = function (limit) {
    if (limit < 1) {
      $scope.query.newLimit = $scope.query.limit; // TODO: Throw a validation error
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/apps/onms-elementList/templates/angular-onms-elementList-editInPlace.html';
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/apps/onms-elementList/templates/angular-onms-elementList-editListInPlace.html';
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/apps/onms-elementList/templates/angular-onms-elementList-editMapInPlace.html';
...
var _iterator = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/@babel/runtime-corejs3/core-js-stable/symbol/iterator */ "./node_modules/@babel/runtime-corejs3/core-js-stable/symbol/iterator.js"));

var _symbol = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/@babel/runtime-corejs3/core-js-stable/symbol */ "./node_modules/@babel/runtime-corejs3/core-js-stable/symbol.js"));
...
var _moment = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/moment/moment */ "./node_modules/moment/moment.js"));
...
function () {
  function ReportDetails() {
    ...
    this.timezoneEditable = true; // In order to have the ui look the same as before, just order the parameters
    ...
    (0, _forEach.default)(_context3 = this.parameters).call(_context3, function (parameter) {
      ...
      parameter.hidden = parameter.name === 'GRAFANA_ENDPOINT_UID' || parameter.name === 'GRAFANA_DASHBOARD_UID' || parameter.name === 'dateFormat'; // index parameters
    ...
    (0, _forEach.default)(_context4 = (0, _filter.default)(_context5 = this.parameters).call(_context5, function (parameter) {
      ...
      parameter.internalValue = (0, _moment.default)(parameter.date, parameter.internalFormat).hours(parameter.hours).minutes(parameter.minutes).format(parameter.internalFormat);
    });
    this.updateTimezoneEditable();
    this.validateTimezone(); // Adjust format
  ...
  _createClass(ReportDetails, [{
    ...
    value: function updateTimezoneEditable() {
      ...
      } else {// either this isn't a grafana report, or we haven't gotten the dashboard timezone (yet)
      }
    }
  }, {
    ...
    value: function validateTimezone() {
      ...
      this.updateTimezoneEditable(); // Ensure timezone has a valid value
      ...
      (0, _forEach.default)(_context9 = (0, _filter.default)(_context10 = this.parameters).call(_context10, function (parameter) {
        ...
        if (_this2.timezoneEditable) {
          ...
          if (parameter.value && (0, _trim.default)(_context11 = parameter.value).call(_context11).length > 0 && (0, _indexOf.default)(_context12 = _this2.supportedTimezones).call(_context12, parameter.value) >= 0) {// we have already selected a valid timezone, carry on
          } else {
            var _context13;

            // otherwise, guess the timezone; If it actually exists, it is used;
            // if it doesn't exist, the first from the list is selected
            var guessedTimezone = _moment.default.tz.guess(true);
        ...
        } else {// if the timezone is not editable, it should already be
    ...
    value: function updateDateParameters() {
      ...
      (0, _forEach.default)(_context14 = (0, _filter.default)(_context15 = this.parameters).call(_context15, function (parameter) {
        ...
        var date = (0, _moment.default)(p.internalValue, p.internalFormat);
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/apps/onms-reports/details.html';
...
(function () {
  ...
  angular.module(MODULE_NAME, ['angular-loading-bar', 'ngResource', 'ngSanitize', 'ui.router', 'ui.select', 'mwl.confirm', 'onms.http', 'onms.default.apps', 'onms.datetimepicker', 'onms.schedule.editor', 'onms.pagination']).config(['$locationProvider', function ($locationProvider) {
  ...
  }]).factory('UserService', ["WhoamiResource", function (WhoamiResource) {
    return {
      whoami: function whoami(successCallback, errorCallback) {
      ...
      link: function link(scope, element, attrs) {
          ...
          if (before && after && before !== after) {
            ...
            (0, _forEach.default)(_context3 = scope.report.parameters).call(_context3, function (parameter, index) {
              if (parameter.type === 'date') {
                var oldDate = _moment.default.tz(parameter.internalValue, before);
        ...
        scope.$watchCollection('selected', function (newSelected) {
          ...
          if (newSelected && newSelected.endpoint && newSelected.endpoint.uid && newSelected.dashboard && newSelected.dashboard.uid) {
            var selectedDashboard = newSelected.dashboard; // the dashboard object you get from search doesn't include the full
    ...
    $scope.runReport = function () {
      $scope.report.resetErrors(); // eslint-disable-next-line no-console
      ...
      $http({
        ...
        var contentDisposition = response.headers("Content-Disposition"); // var filename = (contentDisposition.split(';')[1].trim().split('=')[1]).replace(/"/g, '');
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/apps/onms-reports/modals/schedule-edit-modal.html';
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/apps/onms-reports/report-details.html';
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/apps/onms-reports/schedules.html';
...
__webpack_require__(/*! expose-loader?moment!moment */ "./node_modules/expose-loader/index.js?moment!./node_modules/moment/moment.js-exposed");

__webpack_require__(/*! ../../vendor/jquery-js */ "./src/main/assets/js/vendor/jquery-js.js");
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/lib/onms-datetimepicker/template.html';
...
var _create = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/@babel/runtime-corejs3/core-js-stable/object/create */ "./node_modules/@babel/runtime-corejs3/core-js-stable/object/create.js"));

var _map = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/@babel/runtime-corejs3/core-js-stable/map */ "./node_modules/@babel/runtime-corejs3/core-js-stable/map.js"));

var _bind = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/@babel/runtime-corejs3/core-js-stable/instance/bind */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/bind.js"));

var _construct2 = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/@babel/runtime-corejs3/core-js-stable/reflect/construct */ "./node_modules/@babel/runtime-corejs3/core-js-stable/reflect/construct.js"));

var _indexOf = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/@babel/runtime-corejs3/core-js-stable/instance/index-of */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/index-of.js"));

var _getPrototypeOf3 = _interopRequireDefault(__webpack_require__(/*! ../../../../../../node_modules/@babel/runtime-corejs3/core-js-stable/object/get-prototype-of */ "./node_modules/@babel/runtime-corejs3/core-js-stable/object/get-prototype-of.js"));
...
function _wrapNativeSuper(Class) { var _cache = typeof _map.default === "function" ? new _map.default() : undefined; _wrapNativeSuper = function _wrapNativeSuper(Class) { if (Class === null || !_isNativeFunction(Class)) return Class; if (typeof Class !== "function") { throw new TypeError("Super expression must either be null or a function"); } if (typeof _cache !== "undefined") { if (_cache.has(Class)) return _cache.get(Class); _cache.set(Class, Wrapper); } function Wrapper() { return _construct(Class, arguments, _getPrototypeOf(this).constructor); } Wrapper.prototype = (0, _create.default)(Class.prototype, { constructor: { value: Wrapper, enumerable: false, writable: true, configurable: true } }); return _setPrototypeOf(Wrapper, Class); }; return _wrapNativeSuper(Class); }

function isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !_construct2.default) return false; if (_construct2.default.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call((0, _construct2.default)(Date, [], function () {})); return true; } catch (e) { return false; } }

function _construct(Parent, args, Class) { if (isNativeReflectConstruct()) { _construct = _construct2.default; } else { _construct = function _construct(Parent, args, Class) { var a = [null]; a.push.apply(a, args); var Constructor = (0, _bind.default)(Function).apply(Parent, a); var instance = new Constructor(); if (Class) _setPrototypeOf(instance, Class.prototype); return instance; }; } return _construct.apply(null, arguments); }

function _isNativeFunction(fn) { var _context2; return (0, _indexOf.default)(_context2 = Function.toString.call(fn)).call(_context2, "[native code]") !== -1; }
...
function (_Error) {
  ...
  function ContextError() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ContextError)).call.apply(_getPrototypeOf2, (0, _concat.default)(_context = [this]).call(_context, params)));
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/lib/onms-pagination/pagination-toolbar.html';
...
angular.module(MODULE_NAME, []).directive('onmsScheduleEditor', function () {
  return {
    ...
    link: function link(scope, element, attrs) {
      ...
      scope.weekdays = _Weekdays.default.all; // Updates the cron expression on each option change
      ...
      scope.$watchCollection('options.daysOfWeek', scope.verifyInput); // Change the dayOfMonthToggle if any value was changed from the other "group"
  ...
  return {
    ...
    link: function link(scope, element, attrs) {
      ...
      initMinutes();
      initHours(); // When minutesStep changed, update minutes values
      ...
      scope.$watch('options.mode', function (newValue, oldValue) {
        if (newValue !== oldValue) {
          // convert time
          scope.model.convert(scope.options.mode); // Reset hours as they are different for each mode
...
var Range = function Range(cronHours) {
...
function () {
  ...
  function ScheduleOptions(input) {
    ...
    var options = typeof input === 'undefined' ? {} : input; // Pre populate Values
    ...
    this.daysOfWeek = options.daysOfWeek || {}; // Days per Month
    ...
    this.dayOfMonthToggle = options.dayOfMonthToggle || 'dayOfMonth'; // Custom

    this.cronExpression = options.cronExpression || '0 0/5 * * * ?'; // Report Time Zone to use (if any)

    this.timezone = options.timezone || undefined; // Enable debugging?

    this.showDebugOptions = options.showDebugOptions || false; // Ensure each time is actually a Time object
    ...
    this.to.convert(this.clockMode); // Enforce disabling Minutes

    this.from.options.disableMinutes = true;
    this.to.options.disableMinutes = true; // Enforce correct type
  ...
  _createClass(ScheduleOptions, [{
    ...
    value: function getCronExpression() {
      ...
      this.validate(); // In case of a custom expression, just use it directly
    ...
    value: function getNextExecution(displayZone) {
      ...
      return _moment.default.tz(d, displayZone || this.timezone || _moment.default.tz.guess());
    }
  }, {
    key: "isValid",
...
function () {
  function Time(input, clockMode) {
    ...
    this.mode = this.suffix === null ? _ClockMode.default.FULL_CLOCK_SYSTEM : _ClockMode.default.HALF_CLOCK_SYSTEM; // Reset suffix if 24 clock mode
    ...
    this.verify(); // If a clockMode is defined, automatically convert it
...
function () {
  function WeekdayOptions(input) {
    ...
    var options = {}; // in case of an array, convert it to an object
...
function () {
  ...
  _createClass(DailyParser, [{
    ...
    value: function parse(input) {
      ...
      options.interval = cron.interval; // Parse at, from and to
      ...
      if (options.interval === '0') {
        ...
        var range = new _Range.default(cron.hours); // add one hour offset in case of minutes interval and hours are range
...
function () {
  ...
  _createClass(DayOfMonthParser, [{
    ...
    value: function canParse(input) {
      ...
      var canParse = cron.year === undefined && cron.seconds === '0' && cron.isConcreteMinutes() && cron.isConcreteHours() && cron.month === '*' && (0, _indexOf.default)(_context = cron.dayOfMonth).call(_context, ',') === -1 && (0, _indexOf.default)(_context2 = cron.dayOfMonth).call(_context2, '-') === -1 && (0, _indexOf.default)(_context3 = cron.dayOfMonth).call(_context3, '/') === -1 // If dayOfMonth is set, dayOfWeek must be ?
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/lib/onms-schedule-editor/templates/interval-input.tpl.html';
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/lib/onms-schedule-editor/templates/schedule-editor.tpl.html';
...
var path = '/home/administrator/Desktop/testnms/core/web-assets/src/main/assets/js/lib/onms-schedule-editor/templates/time-input.tpl.html';
