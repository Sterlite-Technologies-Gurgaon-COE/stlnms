...
return (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ksc-wizard"],{

/***/ "./src/main/assets/js/apps/ksc-wizard/index.js":
/*!*****************************************************!*\
  !*** ./src/main/assets/js/apps/ksc-wizard/index.js ***!
  \*****************************************************/
...
(0, _filter.default)(_context = angular.module('onms-ksc-wizard', ['onms.http', 'onms.default.apps', 'ui.bootstrap', 'angular-growl']).config(['growlProvider', function (growlProvider) {
  ...
  $scope.actionUrl = _util.default.getBaseHref() + 'KSC/formProcMain.htm';
      ...
      buttons: {
        reload: {
          ...
          callback: function callback() {
            $http.put('rest/ksc/reloadConfig').success(function () {
  ...
  $scope.selectResource = function (resource) {
    ...
    var baseUrl = _util.default.getBaseHref() + 'KSC/customView.htm';

    if ((0, _indexOf.default)(_context2 = resource.name).call(_context2, ':') > 0) {
...
},[["./src/main/assets/js/apps/ksc-wizard/index.js","vendor"]]]);
});
//# sourceMappingURL=ksc-wizard.js.map