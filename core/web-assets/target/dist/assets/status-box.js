...
return (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["status-box"],{
...
/***/ "./src/main/assets/js/apps/status-box/index.js":
/*!*****************************************************!*\
  !*** ./src/main/assets/js/apps/status-box/index.js ***!
  \*****************************************************/
/*! no static exports found */
...
var c3 = __webpack_require__(/*! ../../vendor/c3-js */ "./src/main/assets/js/vendor/c3-js.js");

var d3 = __webpack_require__(/*! ../../vendor/d3-js */ "./src/main/assets/js/vendor/d3-js.js");

__webpack_require__(/*! ./status-box.css */ "./src/main/assets/js/apps/status-box/status-box.css");

d3.document = window.document; // the color palette to map each severity to
...
var loadChartData = function loadChartData(graph) {
  $.ajax({
    method: 'GET',
    url: graph.url,
    headers: {
    ...
    success: function success(data) {
      var columns = []; // Only include values > 0
      ...
      if (sum > 0) {
        ...
        $('#' + graph.id).parent().show(); // Generate graph
        ...
        var chart = c3.generate({
          ...
          donut: {
            title: graph.title,
            label: {
              format: function format(value, id, ratio) {
                return value;
              }
            }
          }
        ...
        if (description !== '') {
          d3.select('#' + graph.id).select('.c3-chart').append('svg:title').text(description);
        }
      }
    }
  });
...
var render = function render(options) {
  ...
  for (var i = 0; i < graphs.length; i++) {
    ...
    var graph = graphs[i]; // Skip the entry when any of the required fields are missing
...
var doRender = function doRender(graphKeys) {
  ...
  } else {//console.log('no graphs found');
  }
};
...
/***/ "./src/main/assets/js/apps/status-box/status-box.css":
/*!***********************************************************!*\
  !*** ./src/main/assets/js/apps/status-box/status-box.css ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./src/main/assets/js/vendor/c3-js.js":
/*!********************************************!*\
  !*** ./src/main/assets/js/vendor/c3-js.js ***!
  \********************************************/
/*! no static exports found */
...
if (window['c3']) {
  ...
  window['c3'] = __webpack_require__(/*! ../../../../../node_modules/c3/c3 */ "./node_modules/c3/c3.js-exposed");
}
...
},[["./src/main/assets/js/apps/status-box/index.js","vendor"]]]);
});
//# sourceMappingURL=status-box.js.map