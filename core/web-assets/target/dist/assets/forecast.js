...
return (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forecast"],{
...
/***/ "./src/main/assets/js/apps/forecast/index.js":
/*!***************************************************!*\
  !*** ./src/main/assets/js/apps/forecast/index.js ***!
  \***************************************************/
/*! no static exports found */
...
var $ = __webpack_require__(/*! ../../vendor/jquery-js */ "./src/main/assets/js/vendor/jquery-js.js");

var _ = __webpack_require__(/*! ../../vendor/underscore-js */ "./src/main/assets/js/vendor/underscore-js.js");
...
app.controller('forecastCtrl',
/* @ngInject */
["$scope", function ($scope) {
  // Use the first div we find with the data-graph-report attribute
  $scope.graphElement = $('div[data-graph-report]').first(); // Holds a reference to the pristine graph definition, once loaded

  $scope.graphDef = null; // Holds a reference to the graph, once rendered

  $scope.graph = null; // Populated with the list of available series from the graph model

  $scope.series = []; // The different list of options which all forecasting templates inherit
  ...
  function getGraphDefinition(report, resource) {
    var url = getBaseHref() + 'rest/graphs/' + encodeURIComponent(report); // Pull in the graph definition
    ...
    $.ajax({
      ...
      $scope.resource = resource; // Convert the graph definition
      ...
      $scope.series = (0, _filter.default)(_).call(_, rrdGraphConverter.model.series, function (series) {
        return !_.isEmpty(series.name);
      });
      $scope.$apply();
    }).fail(function () {
  ...
  function renderGraph(graphModel, s, e) {
    ...
    var end = e === undefined ? (0, _now.default)() : e;
    var start = s === undefined ? end - 7 * 24 * 60 * 60 * 1000 : s; // Destroy the existing graph, if any
  ...
  $scope.reset = function () {
    clearUserInput(); // Re-render the original graph model
  ...
  $scope.canForecast = function () {
    return $scope.metricToForecast !== null && $scope.forecastingTemplate !== null && $scope.form.$valid && $scope.forecastingOptions.season * 2 < $scope.forecastingOptions.trainingStart;
  };
  ...
  $scope.forecast = function () {
    ...
    var graphModel = rrdGraphConverter.model; // Add series for the trend, forecast and bounds
    ...
    var graphEndInMillis = now; // Add metric filters to prepare, trend and forecast the target metric
...
var _ = __webpack_require__(/*! ../../../../../node_modules/underscore/underscore */ "./node_modules/underscore/underscore.js-exposed");
...
},[["./src/main/assets/js/apps/forecast/index.js","vendor"]]]);
});
