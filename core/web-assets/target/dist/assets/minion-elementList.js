...
return (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["minion-elementList"],{
...
var BASE_REST_URL = 'api/v2'; // Module name
...
angular.module(MODULE_NAME, ['onms.http', 'ngResource']) // OnmsAlarm REST $resource
.factory('alarmFactory',
/* @ngInject */
["$resource", "$log", "$http", "$location", function ($resource, $log, $http, $location) {
...
.factory('monitoringLocationFactory',
/* @ngInject */
["$resource", "$log", "$http", "$location", function ($resource, $log, $http, $location) {
...
/***/ "./src/main/assets/js/apps/onms-elementList/minion-elementList/index.js":
/*!******************************************************************************!*\
  !*** ./src/main/assets/js/apps/onms-elementList/minion-elementList/index.js ***!
  \******************************************************************************/
/*! no static exports found */
...
var mainTemplate = __webpack_require__(/*! ./main.html */ "./src/main/assets/js/apps/onms-elementList/minion-elementList/main.html"); // $filters that can be used to create human-readable versions of filter values


(0, _filter.default)(_context = (0, _filter.default)(_context2 = angular.module('minionListFilters', ['onmsListFilters', 'onmsDateFormatter']).directive('onmsMinionList', function () {
  return {
    restrict: 'E',
    transclude: true,
...
.controller('MinionListCtrl', ['$scope', '$http', '$location', '$window', '$log', '$filter', 'DateFormatterService', 'minionFactory', function ($scope, $http, $location, $window, $log, $filter, DateFormatterService, minionFactory) {
  ...
  $scope.$parent.query.orderBy = 'label'; // Reload all resources via REST
    ...
    DateFormatterService.formatter.finally(function () {
      ...
      minionFactory.query({
        ...
        if (value && value.length > 0) {
          var query = '(' + (0, _map.default)(value).call(value, function (minion) {
        ...
        $scope.$parent.query.lastOffset = contentRange.end; // Subtract 1 from the value since offsets are zero-based
  ...
  $scope.$parent.update = function (item) {
    var saveMe = minionFactory.get({
      ...
      saveMe.properties = item.properties; // TODO
...
/***/ "./src/main/assets/js/apps/onms-elementList/minion-elementList/main.html":
/*!*******************************************************************************!*\
  !*** ./src/main/assets/js/apps/onms-elementList/minion-elementList/main.html ***!
  \*******************************************************************************/
/*! no static exports found */
...
},[["./src/main/assets/js/apps/onms-elementList/minion-elementList/index.js","vendor"]]]);
});
//# sourceMappingURL=minion-elementList.js.map