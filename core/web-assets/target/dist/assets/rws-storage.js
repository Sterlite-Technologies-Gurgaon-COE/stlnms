...
return (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["rws-storage"],{

/***/ "./src/main/assets/js/apps/rws-storage/index.js":
/*!******************************************************!*\
  !*** ./src/main/assets/js/apps/rws-storage/index.js ***!
  \******************************************************/
...
function RWS_InFrameResponseHandler(nameFrame) {
  ...
  return true; // this code is to be enable

  var windowFrame = frames[nameFrame];
  var elementFrame = windowFrame.frameElement;
  var elementFrameDoc = windowFrame.document.documentElement; // detach the response-handler from the target frame
  ...
  elementFrame.RWS_handlerOnLoad = null; // get the text response from the target frame
  ...
  windowFrame.document.location.replace(elementFrame.RWS_hrefLocationOnInit); // re-enable the submit button
...
function RWS_ProcessInFrameResponse(objectForm, functionUserCallback, nameTargetFrame) {
  ...
  if (!(windowFrame = objectForm.RWS_windowTargetFrame)) {
    ...
    objectForm.RWS_windowTargetFrame = windowFrame; // the frame will be the target for the submit's response

    objectForm.target = nameTargetFrame;
  } // obtain the frame element from the frame's window object


  elementFrame = windowFrame.frameElement; // identify the submit button and disable the control
  ...
  elementFrame.RWS_handlerOnLoad = new Function("RWS_InFrameResponseHandler('" + elementFrame.name + "')"); // attach the response-handler to the target frame, so to be executed as
...
},[["./src/main/assets/js/apps/rws-storage/index.js","vendor"]]]);
});
//# sourceMappingURL=rws-storage.js.map