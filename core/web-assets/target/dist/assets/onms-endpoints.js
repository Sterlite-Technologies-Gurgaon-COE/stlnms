...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-endpoints/grafana/grafana.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-endpoints/index.html';
  ...
  angular.module(MODULE_NAME, ['angular-loading-bar', 'ngResource', 'ui.bootstrap', 'ui.router', 'onms.http', 'onms.default.apps', 'mwl.confirm']).run(["confirmationPopoverDefaults", function (confirmationPopoverDefaults) {
    ...
    return $resource('rest/endpoints/grafana/:id', {
      ...
      'delete': {
        ...
        params: {
          id: -1
          /* force to -1 to prevent accidentally deleting all endpoints */
    ...
    $scope.save = function () {
      ...
      $scope.verification.result = undefined; // Close modal afterwards
