...
(0, _filter.default)(_context = angular.module(MODULE_NAME, ['onms.http', 'angular-loading-bar', 'ngRoute', 'ngResource', 'ui.bootstrap', 'onms.elementList', 'onms.pagination']).directive('onmsStatusList', function () {
  return {
    restrict: 'E',
    transclude: true,
...
["$resource", "$log", "$http", "$location", function ($resource, $log, $http, $location) {
  ...
  $scope.updateFilterAndRefreshIfNecessary = function () {
    ...
    var oldList = $scope.query.severityFilter; // Otherwise only update if the severityFilter changed
  ...
  $scope.loadData = function (itemTransformer) {
    var parameters = $scope.query || {}; // update severity filter
    ...
    StatusService.query({
      ...
      switch (response.status) {
        case 500: // on error, simply reset everything
  ...
  $scope.severityFilter = {}; // Update severityFilter based on url query
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/angular-status/templates/filter.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/angular-status/templates/severity-filter.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/angular-status/views/applications.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/angular-status/views/business-services.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/angular-status/views/nodes.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/angular-status/views/unknown.html';
