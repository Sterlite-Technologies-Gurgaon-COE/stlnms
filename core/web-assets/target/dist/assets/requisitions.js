...
return (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["requisitions"],{
...
(function () {
  ...
  angular.module(MODULE_NAME, ['angular-loading-bar', 'ngResource', 'ui.router', 'onms.http']).directive('onmsCentralSearch', function () {
    return {
      restrict: 'E',
      transclude: false,
      ...
      $timeout(function () {
        if ($scope.results.length > 0) {
          ...
          if (e.keyCode === KeyCodes.KEY_UP || e.keyCode === KeyCodes.KEY_DOWN) {
            $scope.navigateSearchResult(e.keyCode); // Ideally we would use scrollToView(), but that will also scroll the body, which
    ...
    $scope.onQueryChange = function () {
      ...
      $scope.results = [];
      $scope.performSearchExecuted = false; // Start timeout before actually searching, this will allow for not invoking when the user
      ...
      $scope.performSearchPromise = $timeout(function () {
        ...
        $timeout.cancel($scope.showLoadingIndicatorPromise); // Kick of loading indicator

        $scope.showLoadingIndicatorPromise = $timeout(function () {
          $scope.showLoadingIndicator = true;
        }, $scope.showLoadingIndicatorDelay); // Cancel any previous request
              ...
              var showMoreElement = {
                ...
                loadMore: function loadMore() {
                  ...
                  SearchResource.query({
                    ...
                    var endIndex = (0, _indexOf.default)(_context2 = $scope.results).call(_context2, showMoreElement); // The result is context focused, so there is only one search result anyways
                    ...
                    $scope.results[$scope.selectedIndex].selected = true; // Hide element
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-central-search/quicksearch.html';
...
var moment = __webpack_require__(/*! ../../../../../../node_modules/moment-timezone */ "./node_modules/moment-timezone/index.js");

__webpack_require__(/*! ../../../../../../node_modules/@rangerrick/moment-javaformat/dist/moment-javaformat */ "./node_modules/@rangerrick/moment-javaformat/dist/moment-javaformat.js"); // eslint-disable-next-line @typescript-eslint/no-empty-function
    ...
    (0, _filter.default)(_context = angular.module('onmsDateFormatter')).call(_context, 'onmsDate', ['$filter', 'DateFormatterService', function ($filter, DateFormatterService) {
      return function onmsDate(input, ifEmpty) {
        ...
        if (window._onmsFormatter) {
          ...
          ret = window._onmsFormatter.format(input); //console.log('onmsDate: formatter returned: ' + ret);
        } else {
          // Otherwise, use ISO format
          ret = $filter('date')(input, 'yyyy-MM-ddTHH:mm:ss.sssZ'); //console.log('onmsDate: $filter(date) returned: ' + ret);
        }
...
var bootbox = __webpack_require__(/*! ../../../../../../../../../node_modules/bootbox/bootbox.all */ "./node_modules/bootbox/bootbox.all.js-exposed");
    ...
    */
    ...
    $scope.initialize = function () {
      ...
      RequisitionsService.getForeignSourceDefinition($scope.foreignSource).then(function (foreignSourceDef) {
        // success
        $scope.foreignSourceDef = foreignSourceDef; // Updating pagination variables for detectors.

        $scope.filteredDetectors = $scope.foreignSourceDef.detectors;
        $scope.updateFilteredDetectors(); // Updating pagination variables for policies.
  ...
  */
  .controller('MetaDataController', ['$scope', '$uibModalInstance', 'node', 'entry', function ($scope, $uibModalInstance, node, entry) {
    ...
    if ($scope.node.interfaces && $scope.node.interfaces.length > 0) {
      ...
      $scope.availableScopes[Scope.INTERFACE] = 'Interface'; // Now filter out the interfaces that have services
    ...
    $scope.entry.service_idx = String($scope.entry.service_idx); // Save the original key so that we can perform proper uniqueness validation
  ...
  */
  .controller('NodeController', ['$scope', '$routeParams', '$cookies', '$window', '$uibModal', 'Configuration', 'RequisitionsService', 'growl', function ($scope, $routeParams, $cookies, $window, $uibModal, Configuration, RequisitionsService, growl) {
      ...
      bootbox.confirm('Are you sure you want to delete the current node?', function (ok) {
        if (ok) {
          ...
          RequisitionsService.deleteNode(node).then(function () {
            ...
            $scope.goBack(); // If node was just created, it has no label yet
    ...
    */
    ...
    }, $scope.errorHandler); // Initialize locations

    RequisitionsService.getAvailableLocations().then(function (locations) {
      // success
      $scope.availableLocations = locations;
    }, $scope.errorHandler); // Initialize foreign-id black list (thanks to the cache, this call is not expensive)
  ...
  .controller('QuickAddNodeController', ['$scope', 'foreignSources', 'RequisitionsService', 'growl', '$sanitize', function ($scope, foreignSources, RequisitionsService, growl, $sanitize) {
    ...
    */
    ...
    RequisitionsService.getAvailableCategories().then(function (categories) {
      // success
      $scope.availableCategories = categories;
    }, $scope.errorHandler); // Initialize requisitions

    if (!foreignSources) {
      RequisitionsService.getRequisitionNames().then(function (requisitions) {
        // success
        $scope.foreignSources = requisitions; // If there is NO requisitions, the user has to create a new one
...
var ip = __webpack_require__(/*! ../../../../../vendor/ipaddress-js */ "./src/main/assets/js/vendor/ipaddress-js.js");
...
var RequisitionMetaData = function RequisitionMetaData(node, requisitionNode) {
  ...
  (0, _forEach.default)(angular).call(angular, node.interface, function (iff) {
    var ri = new RequisitionInterface(iff); // Interface level
...
var RequisitionMetaDataEntry = function RequisitionMetaDataEntry() {
  ...
  var self = this; // Default to the 'node' scope

  self.scope = Scope.NODE; // Must be set to the related RequisitionInterface object when the scope is set to 'interface' or 'service'

  self.scoped_interface = null; // Must be set to the related RequisitionService object when the scope is set to 'service'

  self.scoped_service = null; // Default to using the 'requisition' context
...
var RequisitionMetaData = __webpack_require__(/*! ./RequisitionMetaData */ "./src/main/assets/js/apps/onms-requisitions/lib/scripts/model/RequisitionMetaData.js"); // Internal function for initialization purposes
...
(function () {
  ...
  */
  .factory('RequisitionsService', ['$q', '$cacheFactory', '$window', '$http', '$timeout', '$log', function ($q, $cacheFactory, $window, $http, $timeout, $log) {
    ...
    requisitionsService.internal = {}; // Cache Configuration

    requisitionsService.internal.cacheEnabled = true;
    requisitionsService.internal.cache = $cacheFactory('RequisitionsService'); // URLs
    ...
    requisitionsService.internal.errorHelp = ' Check the OpenNMS logs for more details, or try again later.'; // Timeouts
    ...
    */
    ...
    requisitionsService.updateDeployedStatsForRequisition = function (existingReq) {
      ...
      $http.get(url).success(function (deployedReq) {
        requisitionsService.internal.updateRequisition(existingReq, deployedReq);
    ...
    */
    ...
    requisitionsService.addRequisition = function (foreignSource) {
      ...
      $http.post(url, emptyReq).success(function () {
    ...
    */
    ...
    requisitionsService.deleteRequisition = function (foreignSource) {
      ...
      $q.all([deferredReqPending, deferredReqDeployed, deferredFSPending, deferredFSDeployed]).then(function (results) {
    ...
    */
    ...
    requisitionsService.removeAllNodesFromRequisition = function (foreignSource) {
      ...
      var url = requisitionsService.internal.requisitionsUrl;
      $http.post(url, requisition).success(function (data) {
    ...
    */
    ...
    requisitionsService.saveNode = function (node) {
      ...
      $http.post(url, requisitionNode).success(function (data) {
    ...
    */
    ...
    requisitionsService.saveForeignSourceDefinition = function (foreignSourceDef) {
      ...
      $http.post(url, foreignSourceDef).success(function (data) {
    ...
    */
    ...
    requisitionsService.deleteForeignSourceDefinition = function (foreignSource) {
      ...
      var deferredFSPending = $http.delete(requisitionsService.internal.foreignSourcesUrl + '/' + encodeURIComponent(foreignSource));
      var deferredFSDeployed = $http.delete(requisitionsService.internal.foreignSourcesUrl + '/deployed/' + encodeURIComponent(foreignSource));
      $q.all([deferredFSPending, deferredFSDeployed]).then(function (results) {
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/asset.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/clone-foreignsource.html';
var html = "<div>\n<!-- Alejandro Galue (agalue@opennms.org) -->\n\n<div class=\"modal-header\">\n  <h3 class=\"modal-title\">Clone Foreign Source Definition</h3>\n</div>\n\n<div class=\"modal-body\">\n  <form name=\"cloneForm\">\n    <div class=\"form-group\">\n      <div class=\"form-group\">\n        <label class=\"col-form-label\" for=\"sourceFS\">Source Foreign Source</label>\n        <input class=\"form-control\" type=\"text\" name=\"sourceFS\" ng-disabled=\"true\" ng-model=\"foreignSource\"></input>\n      </div>\n      <div class=\"form-group\">\n        <label class=\"col-form-label\" for=\"targetFS\">Target Foreign Source</label>\n        <input class=\"form-control\" type=\"text\" name=\"targetFS\" placeholder=\"Target Foreign Source to override (hit space bar to see the options)\" ng-model=\"targetForeignSource\" typeahead-min-length=\"0\" typeahead-editable=\"false\" uib-typeahead=\"fs for fs in availableForeignSources | filter:$viewValue\" required></input>\n      </div>\n    </div>\n  </form>\n</div>\n\n<div class=\"modal-footer\">\n  <button type=\"button\" class=\"btn btn-primary\" ng-click=\"save()\" ng-disabled=\"cloneForm.$invalid\">Clone</button>\n  <button type=\"button\" class=\"btn btn-secondary\" ng-click=\"cancel()\" >Cancel</button>\n</div>\n\n</div>\n";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/detector.html';
...
/***/ "./src/main/assets/js/apps/onms-requisitions/lib/views/foreignsource.html":
/*!********************************************************************************!*\
  !*** ./src/main/assets/js/apps/onms-requisitions/lib/views/foreignsource.html ***!
  \********************************************************************************/
/*! no static exports found */
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/foreignsource.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/interface.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/metadata.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/move.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/node-categories.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/node-panels.html';
var html = "<div>\n<!-- Alejandro Galue (agalue@opennms.org) -->\n\n<ol class=\"breadcrumb\">\n  <li class=\"breadcrumb-item\"><a href=\"/opennms/index.jsp\">Home</a></li>\n  <li class=\"breadcrumb-item\"><a href=\"/opennms/admin/index.jsp\">Admin</a></li>\n  <li class=\"breadcrumb-item\"><a href=\"\" ng-click=\"goTop()\">Provisioning Requisitions</a></li>\n  <li class=\"breadcrumb-item\"><a href=\"\" ng-click=\"goBack()\">{{ foreignSource }}</a></li>\n  <li class=\"breadcrumb-item active\">{{ node.nodeLabel }}</li>\n</ol>\n\n<form name=\"nodeForm\" novalidate>\n\n<!-- Toolbar -->\n\n<div class=\"row\">\n  <div class=\"col-md-6\">\n    <h4>Node {{ node.nodeLabel }} at {{ foreignSource }}</h4>\n  </div>\n  <div class=\"col-md-6\">\n    <div class=\"my-4 pull-right\">\n      <button type=\"button\" class=\"btn btn-secondary\" id=\"go-horizontal\" ng-click=\"goHorizontalLayout()\">\n        <span class=\"fa fa-align-justify\"></span> Use Horizontal Layout\n      </button>\n      <button type=\"button\" class=\"btn btn-primary\" id=\"save-node\" ng-click=\"save()\" ng-show=\"nodeForm.$dirty\" ng-disabled=\"nodeForm.$invalid\" ng-disabled=\"timingStatus.isRunning\">\n        <span class=\"fa fa-save\"></span> Save\n      </button>\n      <button type=\"button\" class=\"btn btn-secondary\" uib-tooltip=\"Delete the current Node\" ng-click=\"deleteNode(node)\">\n        <span class=\"fa fa-trash\"></span> Delete\n      </button>\n      <button type=\"button\" class=\"btn btn-secondary\" id=\"go-back\" ng-click=\"goBack()\">\n        <i class=\"fa fa-reply\" aria-hidden=\"true\"></i> Return\n      </button>\n    </div>\n  </div>\n</div>\n\n<!-- Content -->\n\n\n  <div class=\"row\">\n    <!-- Basic Information Tab -->\n    <div class=\"col-md-6\">\n      <div class=\"card\">\n        <div class=\"card-header\">\n          <span>Basic Information</span>\n        </div>\n        <div class=\"card-body\" ng-include=\"nodeBasicView\"/>\n      </div>\n    </div>\n    <!-- Path Outage Tab -->\n    <div class=\"col-md-6\">\n      <div class=\"card\">\n        <div class=\"card-header\">\n          <span>Path Outage</span>\n        </div>\n        <div class=\"card-body\" ng-include=\"nodePathoutagesView\"/>\n      </div>\n    </div>\n  </div> <!-- row -->\n\n  <div class=\"row\">\n    <!-- Interfaces Tab -->\n    <div class=\"col-md-12\">\n      <div class=\"card\">\n        <div class=\"card-header\">\n          <span>IP Interfaces</span>\n        </div>\n        <div class=\"card-body\" ng-include=\"nodeInterfacesView\"/>\n      </div>\n    </div>\n  </div> <!-- row -->\n\n\n  <!-- Meta-Data Panel -->\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <div class=\"card\">\n        <div class=\"card-header\">\n          <span>Meta-Data</span>\n        </div>\n        <div class=\"card-body\" ng-include=\"nodeMetaDataView\"/>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <!-- Assets Tab -->\n    <div class=\"col-md-6\">\n      <div class=\"card\">\n        <div class=\"card-header\">\n          <span>Assets</span>\n        </div>\n        <div class=\"card-body\" ng-include=\"nodeAssetsView\"/>\n      </div>\n    </div>\n    <!-- Categories Tab -->\n    <div class=\"col-md-6\">\n      <div class=\"card\">\n        <div class=\"card-header\">\n          <span>Categories</span>\n        </div>\n        <div class=\"card-body\" ng-include=\"nodeCategoriesView\"/>\n      </div>\n    </div>\n  </div> <!-- row -->\n\n\n</form>\n\n</div>\n";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/node-pathoutages.html';
...
/***/ "./src/main/assets/js/apps/onms-requisitions/lib/views/node.html":
/*!***********************************************************************!*\
  !*** ./src/main/assets/js/apps/onms-requisitions/lib/views/node.html ***!
  \***********************************************************************/
/*! no static exports found */
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/node.html';
var html = "<div>\n<!-- Alejandro Galue (agalue@opennms.org) -->\n\n<ol class=\"breadcrumb\">\n  <li class=\"breadcrumb-item\"><a href=\"/opennms/index.jsp\">Home</a></li>\n  <li class=\"breadcrumb-item\"><a href=\"/opennms/admin/index.jsp\">Admin</a></li>\n  <li class=\"breadcrumb-item\"><a href=\"\" ng-click=\"goTop()\">Provisioning Requisitions</a></li>\n  <li class=\"breadcrumb-item\"><a href=\"\" ng-click=\"goBack()\">{{ foreignSource }}</a></li>\n  <li class=\"breadcrumb-item active\">{{ node.nodeLabel }}</li>\n</ol>\n\n<form name=\"nodeForm\" class=\"mt-4\" novalidate>\n\n<!-- Toolbar -->\n\n<div class=\"row\">\n  <div class=\"col-md-6\">\n    <h4>Node {{ node.nodeLabel }} at {{ foreignSource }}</h4>\n  </div>\n  <div class=\"col-md-6\">\n    <div class=\"my-4 pull-right\">\n      <button type=\"button\" class=\"btn btn-secondary\" id=\"go-vertical\" ng-click=\"goVerticalLayout()\">\n        <span class=\"fa fa-align-center\"></span> Use Vertical Layout\n      </button>\n      <button type=\"button\" class=\"btn btn-primary\" id=\"save-node\" ng-click=\"save()\" ng-show=\"nodeForm.$dirty\" ng-disabled=\"nodeForm.$invalid\" ng-disabled=\"timingStatus.isRunning\">\n        <span class=\"fa fa-save\"></span> Save\n      </button>\n      <button type=\"button\" class=\"btn btn-secondary\" uib-tooltip=\"Delete the current Node\" ng-click=\"deleteNode(node)\">\n        <span class=\"fa fa-trash\"></span> Delete\n      </button>\n      <button type=\"button\" class=\"btn btn-secondary\" id=\"go-back\" ng-click=\"goBack()\">\n        <i class=\"fa fa-reply\" aria-hidden=\"true\"></i> Return\n      </button>\n    </div>\n  </div>\n</div>\n\n<!-- Content -->\n\n<div class=\"row\">\n  <div class=\"col-md-12\">\n\n    <!-- Tab Panel -->\n    <div class=\"container-fluid\">\n      <uib-tabset justified=\"true\">\n\n        <!-- Basic Information Tab -->\n        <uib-tab heading=\"Basic Information\" id=\"tab-basic-information\">\n          <ng-include src=\"nodeBasicView\"/>\n        </uib-tab>\n\n        <!-- Path Outage Tab -->\n        <uib-tab heading=\"Path Outage\" id=\"tab-path-outage\">\n          <ng-include src=\"nodePathoutagesView\"/>\n        </uib-tab>\n\n        <!-- Interfaces Tab -->\n        <uib-tab heading=\"Interfaces\" id=\"tab-interfaces\">\n          <ng-include src=\"nodeInterfacesView\"/>\n        </uib-tab>\n\n        <!-- Assets Tab -->\n        <uib-tab heading=\"Assets\" id=\"tab-assets\">\n          <ng-include src=\"nodeAssetsView\"/>\n        </uib-tab>\n\n        <!-- Categories Tab -->\n        <uib-tab heading=\"Categories\" id=\"tab-categories\">\n          <ng-include src=\"nodeCategoriesView\"/>\n        </uib-tab>\n\n        <!-- Metadata Tab -->\n        <uib-tab heading=\"Meta-Data\" id=\"tab-metadata\" select=\"onMetadataTabSelect()\">\n          <ng-include src=\"nodeMetaDataView\"/>\n        </uib-tab>\n\n      </uib-tabset>\n    </div> <!-- tab-panel container-fluid -->\n\n  </div> <!-- column -->\n</div> <!-- row -->\n\n</form>\n\n</div>\n";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/policy-param.editable.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/policy-param.fixed.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/policy-param.options.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/policy-param.string.html';
var html = "<div>\n\n<div class=\"form-group\">\n  <label class=\"col-form-label\">{{ parameter.key }}</label>\n  <input class=\"form-control\" type=\"text\" name=\"paramValue\" placeholder=\"Parameter Value\" ng-model=\"parameter.value\" required\n         ng-class=\"{ 'is-invalid' : paramForm.paramValue.$invalid }\">\n  <p ng-show=\"paramForm.paramValue.$invalid\" class=\"invalid-feedback\">Parameter value is required.</p>\n</div>\n\n</div>\n";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/policy.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/quick-add-panel-basic.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/quick-add-panel-help.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/quick-add-panel-snmp.html';
...
/***/ "./src/main/assets/js/apps/onms-requisitions/lib/views/requisition.html":
/*!******************************************************************************!*\
  !*** ./src/main/assets/js/apps/onms-requisitions/lib/views/requisition.html ***!
  \******************************************************************************/
/*! no static exports found */
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/requisition.html';
...
/***/ "./src/main/assets/js/apps/onms-requisitions/lib/views/requisitions.html":
/*!*******************************************************************************!*\
  !*** ./src/main/assets/js/apps/onms-requisitions/lib/views/requisitions.html ***!
  \*******************************************************************************/
/*! no static exports found */
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/requisitions.html';
...
/***/ "./src/main/assets/js/apps/onms-requisitions/requisitions/index.js":
/*!*************************************************************************!*\
  !*** ./src/main/assets/js/apps/onms-requisitions/requisitions/index.js ***!
  \*************************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./main */ "./src/main/assets/js/apps/onms-requisitions/requisitions/main.js");

__webpack_require__(/*! ../requisitions-core/index */ "./src/main/assets/js/apps/onms-requisitions/requisitions-core/index.js");

/***/ }),

/***/ "./src/main/assets/js/apps/onms-requisitions/requisitions/main.js":
/*!************************************************************************!*\
  !*** ./src/main/assets/js/apps/onms-requisitions/requisitions/main.js ***!
  \************************************************************************/
/*! no static exports found */
...
var requisitionsView = __webpack_require__(/*! ../lib/views/requisitions.html */ "./src/main/assets/js/apps/onms-requisitions/lib/views/requisitions.html");

var requisitionView = __webpack_require__(/*! ../lib/views/requisition.html */ "./src/main/assets/js/apps/onms-requisitions/lib/views/requisition.html");

var foreignsourceView = __webpack_require__(/*! ../lib/views/foreignsource.html */ "./src/main/assets/js/apps/onms-requisitions/lib/views/foreignsource.html");

var nodeView = __webpack_require__(/*! ../lib/views/node.html */ "./src/main/assets/js/apps/onms-requisitions/lib/views/node.html");

var nodePanelsView = __webpack_require__(/*! ../lib/views/node-panels.html */ "./src/main/assets/js/apps/onms-requisitions/lib/views/node-panels.html");

angular.module('onms-requisitions', ['onms.http', 'onms.default.apps', 'ngRoute', 'ngCookies', 'ngAnimate', 'ui.bootstrap', 'angular-growl', 'angular-loading-bar', 'ngSanitize', 'onmsDateFormatter']).constant('Configuration', {
  'baseHref': _util.default.getBaseHref() + 'admin/ng-requisitions/index.jsp'
}).config(['$routeProvider', function ($routeProvider) {
  $routeProvider.when('/requisitions', {
...
},[["./src/main/assets/js/apps/onms-requisitions/requisitions/index.js","vendor"]]]);
});
