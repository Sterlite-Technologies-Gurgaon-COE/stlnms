...
(0, _filter.default)(_context = angular.module('onms-interfaces', ['onms.http', 'onms.default.apps', 'ui.bootstrap'])).call(_context, 'startFrom', function () {
  ...
  $scope.ipReverse = false; // SNMP Interfaces Variables
  ...
  $scope.snmpIfLoaded = false; // IP Interfaces
  ...
  $scope.updateFlowUrlsForSnmpInterfaces = function () {
    (0, _forEach.default)(angular).call(angular, $scope.snmpInterfaces, function (intf) {
      ...
      }, function errorCallback(response) {// pass
      });
    });
  };
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-interfaces/templates/template.sort.html';
