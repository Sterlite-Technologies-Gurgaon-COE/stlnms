...
(function () {
  ...
  }]).factory('ClassificationGroupService',
  /* @ngInject */
  ["$resource", function ($resource) {
  ...
  }]).factory('ClassificationRuleService',
  /* @ngInject */
  ["$resource", function ($resource) {
  ...
  ["$resource", function ($resource) {
    ...
    $scope.refreshTabs = function (navigateToFirstGroup) {
      return ClassificationGroupService.query({
        ...
        $scope.groups = (0, _reverse.default)(_context3 = $scope.groups).call(_context3); // Select first group if available
    ...
    $scope.sortableGroups = {
      ...
      stop: function stop(e, ui) {
        ...
        if (oldIndex !== newIndex) {
          ...
          group.position = position; // Update backend
    ...
    $scope.sortableRules = {
      ...
      stop: function stop(e, ui) {
        ...
        if (oldIndex !== newIndex) {
          ...
          rule.position = position; // Update backend
      ...
      reader.onload = function (e) {
        ...
        $http({
          ...
          if (status === 400) {
            ...
            if (response.errors) {
              $scope.error = 'The rules could not be imported. Please fix the errors shown below and retry.'; // Persist locally
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-classifications/views/config.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-classifications/views/index.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-classifications/views/modals/export-modal.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-classifications/views/modals/import-modal.html';
