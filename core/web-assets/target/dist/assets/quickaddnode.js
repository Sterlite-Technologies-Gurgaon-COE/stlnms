...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-requisitions/lib/views/quick-add-node-standalone.html';
...
(function () {
  ...
  angular.module('onms-requisitions', ['onms.http', 'onms.default.apps', 'ngRoute', 'ngAnimate', 'ui.bootstrap', 'angular-growl', 'angular-loading-bar', 'ngSanitize', 'onmsDateFormatter']).config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/', {
