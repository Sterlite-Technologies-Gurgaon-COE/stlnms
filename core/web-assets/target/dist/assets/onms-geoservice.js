...
var configTemplate = __webpack_require__(/*! ./views/config.html */ "./src/main/assets/js/apps/onms-geoservice/views/config.html"); // Dynamically referenced
...
(function () {
  ...
  }).factory('GeocodingConfigService',
  /* @ngInject */
  ...
  }]).factory('GeocodingGeocoderService',
  /* @ngInject */
  ["$resource", function ($resource) {
    ...
    $scope.save = function () {
      if ($scope.geocoder) {
        ...
        $scope.geocoder.$update(function () {
          growl.success('Changes saved successfully.');
          $scope.form.$setPristine(); // The data cannot be reloaded from the backend as the bundles will be refreshed and the
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-geoservice/views/config.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-geoservice/views/config/google.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-geoservice/views/config/mapquest.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-geoservice/views/config/nominatim.html';
...
var path = '/home/administrator/Desktop/master27/core/web-assets/src/main/assets/js/apps/onms-geoservice/views/index.html';
