...
angular.module('onms-assets', ['onms.http', 'onms.default.apps', 'ui.bootstrap', 'angular-growl', 'onmsDateFormatter']).config(['growlProvider', function (growlProvider) {
  ...
  */
  ...
  $scope.init = function (nodeId) {
    ...
    $http.get('rest/nodes/' + $scope.nodeId).success(function (node) {
    ...
    $http.get('rest/assets/suggestions').success(function (suggestions) {
  ...
  $scope.updateRequisition = function (assets) {
    ...
    $http.get('rest/requisitions/' + $scope.foreignSource + '/nodes/' + $scope.foreignId).success(function (node) {
      node.asset = assetFields;
      $http.post('rest/requisitions/' + $scope.foreignSource + '/nodes', node).success(function () {
